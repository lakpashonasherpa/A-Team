...
public class QueryUtil {
	...
	public static final String INSERT_SQL_CUSTOMER= "insert into account_info(customer_name,customer_address, customer_mobileNum,customer_unique_idType,customer_unique_id_number,initial_balance) values(?,?,?,?,?,?)";	
	...
	public static final String LIST_CUSTOMER_RECORD_SQL_BY_ID="SELECT account_info.customer_id, account_info.customer_name,account_info.initial_balance, account_balance.deposit_amount, account_balance.withdraw_amount, account_balance.account_balance FROM account_info inner join account_balance WHERE account_info.customer_id = account_balance.customer_id;";
	public static final String GET_TOTAL_BALANCE_BY_ID="select acount_balance from account_balance where customer_id=?";
